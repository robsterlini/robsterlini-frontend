module.exports = {
  ...
  spring: {
    ...
    work: 'finishing up a new homepage experience for visitors to\xa0<a href="https://fueled.com" target="_blank">fueled.com</a>.',
    music: {
      artist: 'Kano',
  ...
  autumn: {
    life: 'learning on the job what it means to be <a href="https://www.instagram.com/p/CFVDboLH0ik/" target="_blank">a pug dad</a> with my fawn puppy named\xa0<a href="https://www.instagram.com/frankiedepug/" target="_blank">Frankie</a>.',
    work: 'refining and iterating on the <abbr title="Robbins Research Institute">RRI</abbr> project through user testing on an alpha\xa0build.',
    music: {
      artist: 'Twenty Thousand\xa0Hertz',
